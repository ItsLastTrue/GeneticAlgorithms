...
//    {
//        public List<double> GetResult_Deviations() => Out_Deviations;
//        public List<double[]> GetResult_Constants() => Out_Constants;
//        public int[] GetResult_NM_Restarts() => Out_NM_Restarts;
//        public int GetResult_BestGenotype() => Result_BestGenotype;
//        public List<double> GetResultGraphPoints() => Points;
...
//        {
//            var get = (SendEstimatorParams)param;
//            for (int i = 0; i < get.CopyToRun; i++)
//            {
//                int num = get.s + i;
//                var nlt = new NeldorMidThreads();
...
//            Est.DeviationCollections(Leaf, index);
...
//            if (Nmer == 0)
//            {
//                Est.BestLeafs[genotypenumber] = new[] {DeviationCollections(new[] {0.0}, genotypenumber)};
//                return;
